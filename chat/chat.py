...
class Chat:
    def __init__(self):
        ...
        self.users = {}
        self.groups = {}
        self.users['pikachu'] = {'nama': 'Pokemon Piika', 'negara': 'Jepang', 'password': 'pikapi', 'incoming': {},
                               'outgoing': {}}
        self.users['tinkerbel'] = {'nama': 'Tinkerbell', 'negara': 'Laut', 'password': 'peterpan', 'incoming': {},
                                   'outgoing': {}}
        self.users['berbi'] = {'nama': 'Berbi Mariposa', 'negara': 'Khayangan', 'password': 'ken', 'incoming': {},
                                 'outgoing': {}}
